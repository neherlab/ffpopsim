...
class haploid_lowd(object):
    ...
    def get_fitness_statistics(self):
        """get_fitness_statistics(self) -> stat"""
    ...
    def _set_allele_frequencies(self, *args, **kwargs):
        """_set_allele_frequencies(self, int DIM1, unsigned long N) -> int"""
    ...
    def _set_genotypes(self, *args, **kwargs):
        """_set_genotypes(self, int len1, int len2) -> int"""
    ...
    **Note**: if the mutation rates for all loci and/or directions are the same,
    ...
    def _set_mutation_rates(self, *args, **kwargs):
        """_set_mutation_rates(self, double IN_ARRAY2) -> int"""
...
class haploid_highd(object):
    ...
    **Note**: fitness is not a phenotypic trait directly, but rather a function of *all*
    ...
    def _get_clone(self, *args, **kwargs):
        """_get_clone(self, unsigned long n) -> clone"""
    ...
    def _get_number_of_all_clones(self):
        """_get_number_of_all_clones(self) -> unsigned long"""
    ...
    def _set_allele_frequencies(self, *args, **kwargs):
        """_set_allele_frequencies(self, double IN_ARRAY1, int n_o_genotypes) -> int"""
    ...
    def _get_allele_frequencies(self, *args, **kwargs):
        """_get_allele_frequencies(self, double ARGOUT_ARRAY1)"""
    ...
    def _get_trait_additive(self, *args, **kwargs):
        """_get_trait_additive(self, double ARGOUT_ARRAY1, int t)"""
    ...
    def _get_genotype(self, *args, **kwargs):
        """_get_genotype(self, unsigned int n, short ARGOUT_ARRAY1)"""
...
class hivpopulation(haploid_highd):
    ...
    **This class is a subclass of haploid_high and offers most of its methods.**
    ...
    """
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self, N = 0, rng_seed = 0, mutation_rate = 3e-5, coinfection_rate = 1e-2, 
    crossover_rate = 1e-3): 
        """
