...
class hivgene(object):
    ...
    second_start = _swig_property(_FFPopSim.hivgene_second_start_get, _FFPopSim.hivgene_second_start_set)
    second_end = _swig_property(_FFPopSim.hivgene_second_end_get, _FFPopSim.hivgene_second_end_set)
    def __init__(self, start_in=0, end_in=10000, second_start_in=0, second_end_in=0): 
        """Structure for an HIV gene."""
        _FFPopSim.hivgene_swiginit(self,_FFPopSim.new_hivgene(start_in, end_in, second_start_in, second_end_in))
    def __str__(self):
        """x.__str__() <==> str(x)"""
...
class hivpopulation(haploid_highd):
    ...
    **This class is a subclass of haploid_high and offers most of its methods.**
    ...
    gag = _swig_property(_FFPopSim.hivpopulation_gag_get, _FFPopSim.hivpopulation_gag_set)
    pol = _swig_property(_FFPopSim.hivpopulation_pol_get, _FFPopSim.hivpopulation_pol_set)
    env = _swig_property(_FFPopSim.hivpopulation_env_get, _FFPopSim.hivpopulation_env_set)
    nef = _swig_property(_FFPopSim.hivpopulation_nef_get, _FFPopSim.hivpopulation_nef_set)
    vif = _swig_property(_FFPopSim.hivpopulation_vif_get, _FFPopSim.hivpopulation_vif_set)
    vpu = _swig_property(_FFPopSim.hivpopulation_vpu_get, _FFPopSim.hivpopulation_vpu_set)
    vpr = _swig_property(_FFPopSim.hivpopulation_vpr_get, _FFPopSim.hivpopulation_vpr_set)
    tat = _swig_property(_FFPopSim.hivpopulation_tat_get, _FFPopSim.hivpopulation_tat_set)
    rev = _swig_property(_FFPopSim.hivpopulation_rev_get, _FFPopSim.hivpopulation_rev_set)
