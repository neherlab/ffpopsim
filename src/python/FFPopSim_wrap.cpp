...
#define SWIGTYPE_p_genotype_value_pair_t swig_types[5]
#define SWIGTYPE_p_haploid_highd swig_types[6]
#define SWIGTYPE_p_haploid_lowd swig_types[7]
...
SWIGINTERN PyObject *_wrap_bitset_output(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  boost::dynamic_bitset< > result;
  
  if (!SWIG_Python_UnpackTuple(args,"bitset_output",0,0,0)) SWIG_fail;
  result = bitset_output();
  {
    unsigned long L = (&result)->size();
    npy_intp dims[1] = {
      (npy_intp) L
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"bitset_output", (PyCFunction)_wrap_bitset_output, METH_NOARGS, (char *)"bitset_output() -> boost::dynamic_bitset< >"},
